...
base_url('barControlador/eliminar/'); ?>" class="btn
...
<p>Total: <?= $total; ?></p>
<a href="<?= base_url('barControlador/index') ?>"
class="btn btn-primary">Volver a la lista de bebidas</a>
...
dle.minjs"></script>
<script
src="https://www.paypal.com/sdk/js?client-id=AZQBCaHQ4lHq6OI-mMRoxPv8nH
